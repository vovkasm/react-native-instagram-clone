...
const MessageItem = ({
  ...
  const _showEmojiOptions = ({
    ...
    Animated.sequence([
      ...
      if (showMsgEmojiSelection) {
        showMsgEmojiSelection(pageX, pageY, index);
      }
    });
  };
  ...
  return (
    <TouchableOpacity
      ...
      style={{
        ...
        ...(lastSeen && (item.yourEmoji || item.ownEmoji)
          ? {paddingBottom: 30}
          : {}),
      }}>
      {!isMyMessage && (
      ...
      <Animated.View
        style={[
          styles.message,
          isMyMessage ? styles.myMessage : styles.yourMessage,
          extraStyle,
          {
            transform: [
              {
