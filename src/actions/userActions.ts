...
import {
  ...
  NotificationSetting,
  PostStoryCommentOptions,
  PrivacyCommentOptions,
  PrivacyProperties,
  PrivacySetting,
  SuccessAction,
  userAction,
 ...
 */
export const FetchExtraInfoRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userAction
...
export const FetchExtraInfoSuccess = (
...
//update extra info
export const UpdateExtraInfoRequest = (
  data: ExtraInfoPayload,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
//
export const FollowContactsRequest = (
  phoneList: string[],
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
export const ToggleFollowUserRequest = (
  username: string,
  refreshExtraInfo: boolean = false,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
      let me: UserInfo = {...store.getState().user.user.userInfo};
...
export const FollowUserFailure = (): ErrorAction => {
  return {
...
//SEND FOLLOW REQUEST
export const ToggleSendFollowRequest = (
  username: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
export const UpdateNotificationSettingsRequest = (
  ...
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
      ...
      type TempIntersection = UserInfo & {
...
export const UpdateNotificationSettingFailure = (): ErrorAction => {
  return {
...
export const UpdatePrivacySettingSuccess = (
  payload: PrivacySetting,
...
export const UpdatePrivacySettingFailure = (): ErrorAction => {
  return {
...
export const RemoveFollowerRequest = (
  username: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
export const FetchSettingRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userAction
...
export const FetchSettingSuccess = (
  payload: UserSetting,
...
export const UnSuggestionRequest = (
  username: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    const me = store.getState().user.user.userInfo;
...
export const FetchRecentSearchRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userAction
> => {
  return async (
    dispatch: ThunkDispatch<{}, {}, SuccessAction<SearchItem[]>>,
  ) => {
    const me = store.getState().user.user.userInfo;
    const ref = firestore();
    const rq = await ref.collection('users').doc(me?.username).get();
...
export const PushRecentSearchRequest = (
...
export const RemoveRecentSearchRequest = (
  searchItem: SearchItem,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    const me = store.getState().user.user.userInfo;
...
export const CreateBookmarkCollectionRequest = (
...
export const RemoveBookmarkCollectionRequest = (
...
export const RemoveFromBookmarkCollectionRequest = (
  postId: number,
  collectionName: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
...
//Archive Actions
export const FetchArchiveRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userAction
...
export const AddStoryArchiveRequest = (
  storyList: StoryArchive[],
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
      const ref = firestore();
...
export const AddPostArchiveRequest = (
  postList: PostArchive[],
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
      const ref = firestore();
...
export const RemovePostArchiveRequest = (
  uid: number,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
//Highlight actions
export const FetchHighlightRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userAction
...
export const RemoveFromHighlightRequest = (
  uid: number,
  targetHighlightName: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
...
export const RemoveHighlightRequest = (
  targetHighlightName: string,
): ThunkAction<Promise<void>, {}, {}, userAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, userAction>) => {
    try {
...
export const EditHighlightRequest = (
