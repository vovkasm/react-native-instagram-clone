...
export const FetchPostListRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  PostAction
 ...
 */
export const LoadMorePostListRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  PostAction
...
export const LoadMorePostListSuccess = (
  payload: PostList,
): PostSuccessAction<PostList> => {
  return {
 ...
 */
export const ToggleLikePostRequest = (
  postId: number,
  postData?: ExtraPost,
  setPost?: React.Dispatch<React.SetStateAction<ExtraPost>>,
): ThunkAction<Promise<void>, {}, {}, PostAction> => {
...
export const ToggleLikePostSuccess = (
  payload: PostList,
): PostSuccessAction<PostList> => {
  return {
      ...
      if (rq.size > 0) {
        ...
        hashTagList.map(async hashtag => {
          ...
          if (rq.size > 0) {
            ...
            keyword.splice(0, 1);
            const fetchRelatedTags: Promise<string[]>[] = keyword.map(
              async character => {
                const rq = await ref
                  .collection('hashtags')
