...
import {
  ...
  userXAction,
  ErrorAction,
} from '../reducers/profileXReducer';

export const FetchProfileXRequest = (
  username: string,
...
export const ResetProfileXRequest = (): ThunkAction<
  Promise<void>,
  {},
  {},
  userXAction
...
export const FetchProfileXSuccess = (
  payload: ProfileX,
): SuccessAction<ProfileX> => {
  return {
