...
import {
  LIMIT_COMMENTS_PER_LOADING,
  CommentAction,
  CommentErrorAction,
  commentActionTypes,
  CommentExtraList,
  CommentList,
  CommentListWithScroll,
 ...
 */
export const LoadMoreCommentListRequest = (
  postId: number,
): ThunkAction<Promise<void>, {}, {}, CommentAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, CommentAction>) => {
    try {
...
export const LoadMoreCommentListSuccess = (
  payload: CommentListWithScroll,
 ...
 */
export const ToggleLikeCommentRequest = (
  postId: number,
  commentId: number,
): ThunkAction<Promise<void>, {}, {}, CommentAction> => {
  return async (dispatch: ThunkDispatch<{}, {}, CommentAction>) => {
...
export const ToggleLikeCommentSuccess = (
  payload: CommentListWithScroll,
): CommentSuccessAction<CommentListWithScroll> => {
  return {
 ...
 */
export const ToggleLikeReplyRequest = (
  replyId: number,
  commentId: number,
  postId: number,
): ThunkAction<Promise<void>, {}, {}, CommentAction> => {
...
export const ToggleLikeReplySuccess = (
  payload: CommentListWithScroll,
): CommentSuccessAction<CommentListWithScroll> => {
  return {
    type: commentActionTypes.TOGGLE_LIKE_COMMENT_SUCCESS,
