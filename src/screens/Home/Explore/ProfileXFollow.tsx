...
const FollowTab = ({userX, type}: {userX: ProfileX; type: 1 | 2}) => {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name={`${mutualCount} Mutual`}
        children={() => <ProfileXMutual userX={userX} />}
      />
      <Tab.Screen
        name={`${followerCount} Followers`}
