...
const FollowRequests = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <NavigationBar title="Follow Requests" callback={goBack} />
      <FlatList
        refreshing={loading}
        ...
        ListHeaderComponent={
          <FlatList
            data={requests}
            renderItem={({item, index}) => <RequestItem {...{item, index}} />}
        ...
        <View>
          ...
          {item.type !== 4 && (
            <Text
              ...
              {item.type === 1
                ? 'Recent Interacted With You'
                : item.type === 2
                ? 'Follows You'
                : item.type === 3
                ? 'Followed by your followings'
                : ''}
            </Text>
          )}
        </View>
