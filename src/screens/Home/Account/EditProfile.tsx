              ...
              firestore()
                ...
                .then(rs => {
                  if (rs.size > 0) {
                    Alert.alert(
                      'Email is used',
                      'Another people used this email!',
                    );
                  } else {
                    dispatch(
                      UpdateUserInfoRequest({
          ...
          phoneValidation
                ...
                .then(rs => {
                  if (rs.size > 0) {
                    Alert.alert(
                      ...
                      'Another people used this phone number!',
                    );
                  } else {
                    dispatch(
                      UpdateUserInfoRequest({
            ...
            .catch(err => {
              Alert.alert(
                ...
                'You need input a vaild phone number',
              );
            });
        }
        break;
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <View style={{backgroundColor: '#000'}}>
              ...
              <TouchableOpacity
                onPress={() =>
                  navigate('GalleryChooser', {isChooseProfilePhoto: true})
                }
                activeOpacity={0.9}
            ...
            <View style={styles.wrapper}>
              ...
              <View>
                ...
                <MaterialInput
                  ...
                  errorMsg={
                    usernameError.length > 0 ? usernameError : undefined
                  }
                  autoCapitalize="none"
                  name="Username"
                  value={username}
