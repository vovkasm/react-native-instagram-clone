...
import {
  RemoveFromBookmarkCollectionRequest,
  RemoveBookmarkCollectionRequest,
...
const SavedCollection = ({route}: SavedCollectionProps) => {
  ...
  const collection = useSelector(state =>
    state.user.bookmarks?.find(x => x.name === collectionName),
  );
          ...
          <View
            ...
            {selectionMode && selectedIndexs.length > 0 ? (
              <Text
                ...
                {selectedIndexs.length} Selected
              </Text>
            ) : (
              <View>
                <Text
        ...
        {selectionMode && (
          <View style={styles.bottomOptions}>
            ...
            <TouchableOpacity
              ...
              disabled={
                selectedIndexs.length === 0 || collectionName === 'All Posts'
              }
              style={styles.bottomOption}>
              <Text
                style={{
