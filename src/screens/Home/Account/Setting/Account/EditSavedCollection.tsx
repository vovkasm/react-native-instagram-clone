...
const EditSavedCollection = ({route}: EditSavedCollectionProps) => {
  ...
  const collection = store
    .getState()
    .user.bookmarks?.find(x => x.name === collectionName);
  ...
  const _onDone = () => {
    if (collection) {
      ...
      dispatch(
        UpdateBookmarkCollectionRequest(collectionName, {
          ...collection,
          name,
        ...
        <View style={styles.navigationBar}>
          <View
            ...
            <Text
              ...
              {mode === 2 ? 'Change Cover' : 'Edit Collection'}
            </Text>
          </View>
          {mode !== 2 && (
            <TouchableOpacity
          ...
          <React.Fragment>
            ...
            <View>
              ...
              <Text
                ...
                When you delete this collection, the photos and videos will
                still be saved
              </Text>
            </View>
          </React.Fragment>
