...
const LiveIGTV = (): JSX.Element => {
  ...
  const liveIGTV = useSelector(
    state => state.user.setting?.notification?.liveIGTV,
  );
  ...
  const _onChangeIGTVVideoUploads = React.useCallback(
  ...
  const _onChangeIGTVViewCounts = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          liveIGTV: {
      ...
      <ScrollView
        ...
        <View style={styles.optionsWrapper}>
          ...
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            vucms started a live video. Watch it before it ends!
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            Your video is ready to watch on IGTV.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            Your IGTV video há mỏe than 100K views.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
