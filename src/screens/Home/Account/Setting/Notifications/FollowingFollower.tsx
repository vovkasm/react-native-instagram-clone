...
const FollowingFollower = (): JSX.Element => {
  ...
  const followingFollowers = useSelector(
    state => state.user.setting?.notification?.followingFollowers,
  );
  ...
  const _onChangeFollowerRequest = React.useCallback(
  ...
  const _onChangeAcceptedFollowRequest = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          followingFollowers: {
  ...
  const _onChangeFriendsOnInstagram = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          followingFollowers: {
  ...
  const _onChangeMentionsInBio = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          followingFollowers: {
  ...
  const _onChangeRecommendationsForOthers = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          followingFollowers: {
  ...
  const _onChangeRecommendationsFromOthers = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          followingFollowers: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.optionsWrapper}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            vucms has requested to follow you.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            vucms accepted your follow request.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            Your Facebook friend VuCms is on Instagram as vucms.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            vucms mentioned you in their bio.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          <Text
            ...
            Help vucms get started on Instagram by recommending accounts to
            follow.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          ...
          <Text
            ...
            vucms throught you might like these accounts.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
