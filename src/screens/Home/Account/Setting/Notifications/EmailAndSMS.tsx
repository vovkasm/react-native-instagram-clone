...
const EmailAndSMS = (): JSX.Element => {
  ...
  const emailAndSMSNotifications = useSelector(
    state => state.user.setting?.notification?.emailAndSMSNotifications,
  );
  const [currentSetting, setCurrentSetting] =
    useState<EmailandSMSNotificationsOptions>({
        ...
        <View style={styles.optionsWrapper}>
          ...
          <View style={styles.optionItem}>
            <View style={styles.option}>
              ...
              <Text style={{fontSize: 12, color: '#666'}}>
                Get notifications you my have missed.
              </Text>
            </View>
            <Switcher
          ...
          <View style={styles.optionItem}>
            <View style={styles.option}>
              ...
              <Text style={{fontSize: 12, color: '#666'}}>
                Get típ about Instagram's tools.
              </Text>
            </View>
            <Switcher
          ...
          <View style={styles.optionItem}>
            <View style={styles.option}>
              ...
              <Text style={{fontSize: 12, color: '#666'}}>
                Get notifications by text messages.
              </Text>
            </View>
            <Switcher
