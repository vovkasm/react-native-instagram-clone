...
const DirectMessages = (): JSX.Element => {
  ...
  const directMessages = useSelector(
    state => state.user.setting?.notification?.directMessages,
  );
  ...
  const _onChangeMessageRequests = React.useCallback(
  ...
  const _onChangeGroupRequests = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          directMessages: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.optionsWrapper}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            vucms wants to add vucms to your group.
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
          ...
          />
          <Text style={{fontSize: 12, color: '#666', paddingHorizontal: 15}}>
            Incoming video chat from vucms.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
