...
const PostStoryComment = (): JSX.Element => {
  ...
  const postStoryComment = useSelector(
    state => state.user.setting?.notification?.postStoryComment,
  );
  ...
  const _onChangeLikesandCommentonMyPhoto = React.useCallback(
  ...
  const _onChangeCommentLikesandPins = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          postStoryComment: {
  ...
  const _onChangeFirstPostsandStories = React.useCallback(
    (value: NotificationLevel) => {
      dispatch(
        UpdateNotificationSettingsRequest({
          postStoryComment: {
      ...
      <ScrollView
        ...
        <View style={styles.optionsWrapper}>
          ...
          <Text
            ...
            vucms commented: "Nice shot!" and other similar notifications
          </Text>
        </View>
        <View style={styles.optionsWrapper}>
          <View style={styles.settingItem}>
            <Text style={{fontWeight: '600', fontSize: 16}}>
              First Post and Stories
            </Text>
          </View>
          <Radio
            labels={['Off', 'From People I Follow', 'From Everyone']}
          ...
          <Text
            ...
            vucms's first story on Instagram and other similar notifications.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
