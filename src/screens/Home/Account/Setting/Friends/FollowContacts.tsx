          ...
          request(PERMISSIONS.IOS.CONTACTS).then(result2 => {
            switch (result2) {
              case RESULTS.BLOCKED:
                Alert.alert(
                  'Error',
                  "This service isn't availabel in your device!",
                );
                navigation.goBack();
                break;
              case RESULTS.DENIED:
              ...
              case RESULTS.GRANTED:
                ...
                Contacts.getAllWithoutPhotos((err, contacts) => {
                  if (err) {
                    ...
                    (async () =>
                      await dispatch(FollowContactsRequest(phoneList)))().then(
                      () => {
                        setSyncing(false);
                        navigation.goBack();
                      },
    ...
    <View style={styles.container}>
      ...
      {!syncing && (
        <View style={styles.mainContainer}>
          <Image
            source={require('../../../../../assets/images/follow-contact.png')}
          />
          <Text
            style={{
              fontWeight: '600',
          ...
          <Text
            ...
            To help people connect on Instagram, you can choose to have your
            contacts periodically synced and stored on our servers. You pick
            which contacts to follow. Disconnect anytime to stop asyncing.
          </Text>
