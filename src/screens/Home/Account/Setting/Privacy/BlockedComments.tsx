...
const BlockedComments = () => {
  ...
  const blockedComments = useSelector(
    state => state.user.setting?.privacy?.comments?.blockUsers,
  );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View
        ...
        <View
          ...
          <Icon color="#666" name="magnify" size={20} />
        </View>
        <TextInput
          autoCapitalize="none"
          value={query}
      ...
      <ScrollView
        style={{
          backgroundColor: '#fff',
          height:
            SCREEN_HEIGHT - STATUS_BAR_HEIGHT - getTabBarHeight() - 44 - 60,
        }}
        ...
        {result.length === 0 && blockList.length === 0 && (
          <View
            ...
            <Text
              ...
              People won't be notified when you block them. Any new comments
              they make on your posts won't be visible to anyone but them.
            </Text>
          </View>
        )}
      </ScrollView>
    ...
    <View style={styles.peopleItem}>
      ...
      <TouchableOpacity
        ...
        style={{
          ...styles.btnBlock,
          backgroundColor:
            blockList.indexOf(userx.username || '') > -1 ? '#ddd' : '#318bfb',
          width: blockList.indexOf(userx.username || '') > -1 ? 70 : 60,
        }}>
        <Text
          style={{
            fontWeight: 'bold',
            color:
              blockList.indexOf(userx.username || '') > -1 ? '#000' : '#fff',
          }}>
          {blockList.indexOf(userx.username || '') > -1 ? 'Unblock' : 'Block'}
        </Text>
      </TouchableOpacity>
    </View>
  );
