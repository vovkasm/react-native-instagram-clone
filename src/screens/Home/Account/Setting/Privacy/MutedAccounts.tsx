...
const MutedAccounts = (): JSX.Element => {
  ...
  const [mutedPostAccounts, setMutedPostAccounts] = useState<string[]>(
    mutedAccounts?.posts || [],
  );
  const [mutedStoryAccounts, setMutedStoryAccounts] = useState<string[]>(
    mutedAccounts?.story || [],
  );
            ...
            <TouchableOpacity style={styles.peopleItem}>
              ...
              <View>
                ...
                <Text style={{color: '#666'}}>
                  ...
                  {userX.mutedPost && !userX.mutedStory && 'Post muted'}
                  {!userX.mutedPost && userX.mutedStory && 'Story muted'}
                </Text>
              </View>
            </TouchableOpacity>
          ))}
