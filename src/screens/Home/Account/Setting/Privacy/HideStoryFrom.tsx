...
const HideStoryFrom = (): JSX.Element => {
  ...
  const hideStoryFrom = useSelector(
    state => state.user.setting?.privacy?.story?.hideStoryFrom,
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        style={{
          height: SCREEN_HEIGHT - STATUS_BAR_HEIGHT - getTabBarHeight() - 70,
        }}
        bounces={false}
...
const UserItem = ({
  ...
  _onToggleHide: (username: string) => void;
  userX: UserInfo;
  hideList: string[];
}) => {
  return (
