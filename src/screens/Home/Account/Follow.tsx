...
const Follow = ({route}: FollowProps) => {
  ...
  const [selectedUnfollowIndex, setSelectedUnfollowIndex] =
    useState<number>(-1);
  const [selectedFollowingIndex, setSelectedFollowingIndex] =
    useState<number>(-1);
  const [followers, setFollowers] = useState<MixedUserInfo[]>([]);
  const [followersRenderList, setFollowersRenderList] = useState<
    MixedUserInfo[]
  >([]);
  const [follwings, setFollowings] = useState<MixedUserInfo[]>([]);
  const [follwingsRenderList, setFollowingsRenderList] = useState<
    MixedUserInfo[]
  >([]);
  ...
  useEffect(() => {
    ...
    if (followerQuery.length > 0) {
      ...
      setFollowersRenderList([...followers]);
    }
  }, [followerQuery]);
  ...
  useEffect(() => {
    ...
    if (followingQuery.length > 0) {
      ...
      setFollowingsRenderList([...follwings]);
    }
  }, [followingQuery]);
  ...
  useEffect(() => {
    if (extraInfo) {
      ...
      const dontFollowUsrnames = [
        ...followerUsrnames.filter(usr => follwingUsrnames.indexOf(usr) < 0),
      ];
      ...
      if (requestedUsrname) {
        ref
          .collection('users')
          .doc(requestedUsrname)
          .get()
          .then(rs => {
            setLastRequest(rs.data() || {});
          });
      }
      const taskFollowers: Promise<
        MixedUserInfo & {
      ...
      Promise.all(taskFollowers).then(result => {
        ...
        const dontFollowBackUsers = [
          ...result.filter(
            usr => dontFollowUsrnames.indexOf(usr.username || '') > -1,
          ),
        ];
        ...
        ref
          ...
          .then(rs => {
            ...
            rs.docs.map(post => {
              ...
              data.likes?.map(usr => interactionList.push(usr));
              data.commentList?.map(usr => interactionList.push(usr));
            });
            interactionList = Array.from(new Set(interactionList));
            const temp = [
              ...result.filter(
                usr => interactionList.indexOf(usr.username || '') > -1,
              ),
            ];
  ...
  const _onToggleFollow = (index: number) => {
    dispatch(
      ToggleFollowUserRequest(followersRenderList[index].username || '', true),
    );
  };
  ...
  const _onUnFollow = (index: number) => {
    ...
    if (follwingsRenderList[index].followType === 1) {
      ...
      if (follwingsRenderList[index].private) {
        dispatch(
          ToggleSendFollowRequest(follwingsRenderList[index].username || ''),
        );
        temp[index].followType = 3;
      } else {
        dispatch(
          ToggleFollowUserRequest(follwingsRenderList[index].username || ''),
        );
    ...
    <SafeAreaView style={styles.container}>
      ...
      {selectedIndex > -1 && (
        <TouchableOpacity
          ...
          <View style={styles.confirmBox}>
            <FastImage
              style={styles.avatar}
              source={{uri: followersRenderList[selectedIndex].avatarURL}}
            />
            <Text
              style={{
                marginTop: 15,
            ...
            <Text
              ...
              Instagram won't tell {followersRenderList[selectedIndex].username}{' '}
              they were removed from your followers.
            </Text>
            <TouchableOpacity
              onPress={() =>
                _onConfirmRemoveFollower(
                  followersRenderList[selectedIndex].username || '',
                )
              }
        ...
        <TouchableOpacity
          ...
          <View style={styles.confirmBox}>
            <FastImage
              style={styles.avatar}
              source={{
                uri: follwingsRenderList[selectedUnfollowIndex].avatarURL,
              }}
            />
            <Text
              style={{
            ...
            <Text
              ...
              {follwingsRenderList[selectedUnfollowIndex].username}
            </Text>
            <TouchableOpacity
              onPress={() =>
                _onConfirmUnFollow(
      ...
      <View style={styles.navigationBar}>
        ...
        <View
          ...
          <TouchableOpacity onPress={() => _onSwitchTab(1)} style={styles.tab}>
            <Text
              style={{
                fontWeight: '500',
              }}>
          ...
          <TouchableOpacity onPress={() => _onSwitchTab(2)} style={styles.tab}>
            <Text
              style={{
                fontWeight: '500',
              }}>
                    ...
                    <View
                      ...
                      <View style={styles.requestNumber}>
                        <Text
                          ...
                          {extraInfo?.requestedList.length}
                        </Text>
                      </View>
                    </View>
                    <View>
                ...
                <View style={styles.headerList}>
                  ...
                  <View style={styles.categoriesWrapper}>
                    ...
                    {dontFollowBackList.length > 0 && (
                      <TouchableOpacity
                        onPress={() => navigate('AccountYouDontFollowBack')}
                        ...
                        <View>
                          <Text
                            ...
                            Account You Don't Follow Back
                          </Text>
                          <Text
                            style={{
                              color: '#666',
                            }}>
                            {dontFollowBackList[0].username} and{' '}
                            {dontFollowBackList.length - 1} others
                          </Text>
                        </View>
                      </TouchableOpacity>
                    )}
                      ...
                      <TouchableOpacity
                        ...
                        <View>
                          <Text
                            ...
                            Recent Interacted With
                          </Text>
                          <Text
                            style={{
                              color: '#666',
                            }}>
                            {recentFollowerInteractionList[0].username} and{' '}
                            {recentFollowerInteractionList.length - 1} others
                          </Text>
                        </View>
                      </TouchableOpacity>
                    )}
                ...
                <View style={styles.headerList}>
                  ...
                  <View style={styles.categoriesWrapper}>
                    ...
                    {recentFollowingsInteractionList.length > 0 && (
                      <TouchableOpacity
                        onPress={() => navigate('RecentFollowingInteraction')}
                        style={styles.categoryItem}>
                        {recentFollowingsInteractionList.length >= 2 ? (
                          <View
                            ...
                            <FastImage
                              ...
                              source={{
                                uri: recentFollowingsInteractionList[0]
                                  .avatarURL,
                              }}
                            />
                            <FastImage
                              ...
                              source={{
                                uri: recentFollowingsInteractionList[1]
                                  .avatarURL,
                              }}
                            />
                          </View>
                        ...
                        <View>
                          ...
                          <Text
                            ...
                            {recentFollowingsInteractionList[0].username} and{' '}
                            {recentFollowingsInteractionList.length - 1} others
                          </Text>
                        </View>
                      </TouchableOpacity>
                    )}
