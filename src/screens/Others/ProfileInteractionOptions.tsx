...
type ProfileInteractionOptionsRouteProp = RouteProp<
  ...
  const _toggleCloseFriend = async () => {
    ...
    if (rq.exists) {
      ...
      const currentCloseFriends =
        data.privacySetting?.closeFriends?.closeFriends || [];
          ...
          {followType === 1 && (
            <View
              ...
              <TouchableOpacity
                ...
                <Image
                  style={styles.closeFriendIcon}
                  source={
                    closeFriends.indexOf(userX.username || '') > -1
                      ? require('../../assets/icons/close-friend.png')
                      : require('../../assets/icons/unclose-friend.png')
                  }
                />
              </TouchableOpacity>
              <TouchableOpacity
