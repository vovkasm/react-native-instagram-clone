...
type ProfileOptionsRouteProp = RouteProp<
...
const ProfileOptions = ({route}: ProfileOptionsProps) => {
  ...
  const _onConfirmBlock = async () => {
    ...
    if (rq.exists) {
      ...
      const targetFollowingIndex =
        currentTargetUserFollowings.indexOf(myUsername);
  ...
  const _onConfirmRestrict = async () => {
    ...
    if (rq.exists) {
      const myUserData: ProfileX = rq.data() || {};
      const currentRestrictList =
        myUserData.privacySetting?.restrictedAccounts?.restrictedAccounts || [];
      ...
      {confirmBlock && (
        <TouchableOpacity
          ...
          <View style={styles.confirmBlock}>
            ...
            <TouchableOpacity onPress={_onConfirmBlock} style={styles.btn}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: '600',
          ...
          <View style={styles.confirmBlock}>
            ...
            <View
              ...
              <Text
                ...
                posts.You'll control if others can see their new comments on
                your posts.
              </Text>
            </View>
            <View
              ...
              <Text
                ...
                Their chat will be moved to your Message Requests, so they won't
                see when you've read it.
              </Text>
            </View>
            <TouchableOpacity onPress={_onConfirmRestrict} style={styles.btn}>
              <Text
                style={{
                  fontSize: 16,
                  fontWeight: '600',
