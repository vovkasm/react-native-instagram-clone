                ...
                <View style={styles.step3Wrapper}>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      This won't be part of your public profile. Why do I need
                      to provide my birthday?
                    </Text>
                  </View>
      ...
      {step === 2 && (
        <View style={styles.syncContactDescription}>
          <Text
            ...
            servers to help you and others find friends, and to help us provide
            a better service. To remove contact, go to Settings and disconnect.
            <Text
              style={{
                color: '#000',
              }}>
