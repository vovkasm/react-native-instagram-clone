...
const AccountStack = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        component={RecentFollowingInteraction}
        name="RecentFollowingInteraction"
      />
      <Stack.Screen
        component={RecentFollowerInteraction}
        name="RecentFollowerInteraction"
      />
      <Stack.Screen component={Archive} name="Archive" />
      <Stack.Screen
        component={AccountYouDontFollowBack}
        name="AccountYouDontFollowBack"
      />
      <Stack.Screen
        component={SettingNavigationx.AddAccount}
        name="AddAccount"
      />
      {settingNavigationMap.map((settingNavigation, index) => (
        <React.Fragment key={index}>
          <Stack.Screen
            component={settingNavigation.component}
            name={settingNavigation.navigationName}
          />
          {settingNavigation.child &&
            settingNavigation.child.map((childSettingNavigation, index2) => (
              <React.Fragment key={index2}>
                {childSettingNavigation.navigationName === 'FollowContact' ? (
                  <Stack.Screen
                    ...
                    component={childSettingNavigation.component}
                    name={childSettingNavigation.navigationName}
                  />
                ) : (
                  <Stack.Screen
                    component={childSettingNavigation.component}
      ...
      <Stack.Screen
        component={SettingNavigationx.BlockedComments}
        name="BlockedComments"
      />
      <Stack.Screen
        component={SettingNavigationx.HideStoryFrom}
        name="HideStoryFrom"
      />
    </Stack.Navigator>
  );
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({focused}) => (
            <Icon name="plus-box" size={30} color={'#ddd'} />,
