...
import GalleryChooser, {
  ProcessedImage,
} from '../screens/Home/Account/GalleryChooser';
...
import StoryProcessor, {
  StoryProcessedImage,
} from '../screens/Others/StoryProcessor';
    ...
    <NavigationContainer ref={navigationRef}>
      <RootStack.Navigator
        ...
        <RootStack.Screen
          ...
          name="AddToHighlights"
          component={AddToHighlights}
        />
        <RootStack.Screen
          options={{
            animationEnabled: false,
        ...
        <RootStack.Screen
          ...
          name="ProfileInteractionOptions"
          component={ProfileInteractionOptions}
        />
        <RootStack.Screen
          options={{
            ...TransitionPresets.ModalTransition,
          ...
          name="MoveBookmarkOptions"
          component={MoveBookmarkOptions}
        />
        <RootStack.Screen
          options={{
            ...TransitionPresets.ModalTransition,
        ...
        <RootStack.Screen
          ...
          name="HighlightFullView"
          component={HighlightFullView}
        />
        <RootStack.Screen
        ...
        <RootStack.Screen
          ...
          name="SuperImageFullView"
          component={SuperImageFullView}
        />
        ...
        <RootStack.Screen
          ...
          name="StoryViewerOptions"
          component={StoryViewerOptions}
        />
      </RootStack.Navigator>
    </NavigationContainer>
  );
